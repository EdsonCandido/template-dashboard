    ...
    return (
        <Flex
            ...
            <Stack
                ...
                p={6}
                my={12}>
                <Heading style={{ textAlign: 'center' }} lineHeight={1.1} fontSize={{ base: '2xl', md: '3xl' }} >
                ...
                <FormControl id="email" isRequired>
                    ...
                    <Input isDisabled={isLoadingSubmit}
                        value={loginTxt}
                ...
                <FormControl id="password" isRequired>
                    ...
                    <Input isDisabled={isLoadingSubmit} type="password" value={passwordTxt} onKeyUp={onKeyPress} onChange={(e) => setPasswordTxt(e.target.value)} />
                </FormControl>
                <Stack spacing={6}>
                    ...
                    <Button isLoading={isLoadingSubmit}
